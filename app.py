...
# ----------------- 1. 页面基本配置与样式隐藏 -----------------
st.set_page_config(
    page_title="岗位职业危害告知书分发系统", page_icon="📋", layout="centered"
)
...
DEPARTMENT_DATA = {
    "技术部": {
        ...
        "description": (
            "涉及技术研发、打样测试及设备调试等过程中的危害暴露与防护要求。"
        ),
        "key_hazards": "微弱电磁辐射、噪声、粉尘、挥发性化学品试剂、机械运转伤害等",
        "target_audience": "技术工程师、研发员、测试员、打样技术员",
    },
    "品管部": {
        "file_name": "职业危害告知书 - 品管部.pdf",
        "description": (
            "涉及来料抽检、理化实验室检测、生产过程巡检等环节的危害管控与健康监护。"
        ),
        "key_hazards": "化学检测试剂、微量粉尘、实验室挥发性气体等",
        "target_audience": "QA/QC人员、巡检员、实验室化验员",
    },
    "生产部": {
        "file_name": "职业危害告知书 - 生产部.pdf",
        "description": (
            "生产车间一线岗位，严格落实接触粉尘、高温、噪声等职业病危害因素的告知制度。"
        ),
        "key_hazards": "生产性粉尘、高温作业、机械性伤害、有机溶剂等",
...
if selected_dept != "-- 请选择部门 --":
  ...
  if os.path.exists(file_path):
    ...
    st.error(
        ...
        f"**排查建议**：\n"
        f"1. 请确认您的电脑或 GitHub 仓库中有一个名为 `attachments`"
        f" 的文件夹。\n"
        f"2. 请检查该文件夹内是否有名为 `{dept_info['file_name']}` 的 PDF"
        " 文件（注意核对文件名是否完全一致，不能有多余的空格或字符错误）。"
    )
